declare class BufferPolyfill extends Uint8Array {
    ...
    static from(source: string | ArrayBuffer | SharedArrayBuffer | Uint8Array | number[] | ArrayLike<number> | Iterable<number>, encOrMapper?: string | number | ((v: unknown, i: number) => number), ctx?: unknown): BufferPolyfill;
